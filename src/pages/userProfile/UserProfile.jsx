                  ...
                  <div className={cx("info-container__right")}>
                    {(() => {
                      if (customerRanking === RANKING_BRONZE) {
                        return <MdDiamond style={{ fontSize: 40, marginRight: '-6px', color: '#A77044' }} />
                      }
                      else if (customerRanking === RANKING_SILVER) {
                        return <MdDiamond style={{ fontSize: 40, marginRight: '-6px', color: '#D7D7D7' }} />
                      }
                      else if (customerRanking === RANKING_GOLD) {
                        return <MdDiamond style={{ fontSize: 40, marginRight: '-6px', color: '#FEE101' }} />
                      }
                      else if (customerRanking === RANKING_PLATINUM) {
                        return <MdDiamond style={{ fontSize: 40, marginRight: '-6px', color: '#79CCE4' }} />
                      }
                      else if (customerRanking === RANKING_DIAMOND) {
                        return <MdDiamond style={{ fontSize: 40, marginRight: '-6px', color: '#225684' }} />
                      }
                    })()}
                  </div>
                </div>
